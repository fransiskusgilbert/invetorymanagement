                    ...
                    <div class="wrapper-search-contents">
                        ...
                        <div class="button-export-excel-srt-container">
                            <div class="button-export-excel-srt-wrapper">
                                <form action="../convert_dataobat_to_excell_sortdate.php" method="GET">
                    ...
                    <div class="tb-dataobat">
                        <table>
                            ...
                            if (isset($_GET['cari'])) {
                                ...
                                if (!empty($cari)) {
                                    $getDataObat = "SELECT * FROM dataobat_tb WHERE dataobat_tglMasuk LIKE '%" . $cari .
                            ...
                            if (mysqli_num_rows($showDataObat) > 0) {
                                while ($viewDataObat = mysqli_fetch_array($showDataObat)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $viewDataObat['dataobat_hargaModal']; ?>
                                        </td>
                                        <td>
                                            <?php echo $viewDataObat['dataobat_hargaJual']; ?>
                                        </td>
                                        <td>
                                            <?php echo $viewDataObat['dataobat_tglMasuk']; ?>
                                        </td>
                                        <td>
                                            <?php echo $viewDataObat['dataobat_tglExpired']; ?>
                                        </td>
                                        <td>
                                            <?php echo $viewDataObat['dataobat_jlhStockMasuk'] . $spasi . $viewDataObat['dataobat_format']; ?>
                                        </td>
                                        <td>
                                            <?php echo ($viewDataObat['dataobat_hargaJual'] * $viewDataObat['dataobat_jlhStockMasuk']); ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-edit-dataobat">
                                                <a
                                                    href="edit_dataobat.php?dataobat_id=<?php echo $viewDataObat['dataobat_id']; ?>">
                                                    <p>Edit</p>
                                                </a>
                                                <a
                                                    href="hapus_dataobat.php?dataobat_id=<?php echo $viewDataObat['dataobat_id']; ?>">
                                                    <p>Hapus</p>
                                                </a>
                                            </div>
                                        </td>
                        ...
                        <!-- Pagination links -->
                        <?php
                        $total_records_sql = "SELECT COUNT(*) AS total_records FROM dataobat_tb WHERE dataobat_tglMasuk LIKE '%" . $cari . "%'";
                        ...
                        for ($i = 1; $i <= $total_pages; $i++) {
                            if ($i == $page) {
                                ...
                                if ($i == 1 || $i == $total_pages || ($i >= $page - 2 && $i <= $page + 2)) {
                                    echo '<li><a href="search_dataobat.php?cari=' . urlencode($cari) . '&page=' . $i . '">' . $i . '</a></li>';
                                } elseif ($i < $page - 2 && $i > 1) {
